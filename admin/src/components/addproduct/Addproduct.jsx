...
const Addproduct = () => {
    ...
    const add_Product = async () => {
        ...
        await fetch('https://mern-cloth-ordering-website.onrender.com/upload', {
            method: 'POST',
            headers: {
                Accept: 'application/json',
            },
        ...
        if (responseData.success) {
            product.image = responseData.image_url;
            console.log(product);
            // Update the URL to the deployed backend for adding the product
            await fetch('https://mern-cloth-ordering-website.onrender.com/addproduct', {
                method: 'POST',
                headers: {
                    Accept: 'application/json',
                    'Content-Type': 'application/json',
